...
export default function LauraProfile() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Image style={styles.img} source={require('../../assets/laura.jpg')} />
            ...
            <View style={{ flexDirection: "row", justifyContent: "center", gap: 20 }}>
                ...
                <Image style={styles.social} source={require('../../assets/linkedin.png')} />
                </TouchableOpacity>
                <TouchableOpacity onPress={openGitHub} >
                <Image style={styles.social} source={require('../..assets/github.png')} />
                </TouchableOpacity>
            </View>
        </View>
    );
